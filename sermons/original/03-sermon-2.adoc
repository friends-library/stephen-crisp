[short="Sermon II. Heart Preparation for Receiving the Gospel."]
...
for there is a _seal_ upon them, and none can open that seal,
...
for it is an _inward work_ that must be done upon the soul,
