...
he has found out one way, in his infinite wisdom, and unspeakable mercy to mankind,
...
if God had not found out a way; and the way that God has found out,
...
and close with it, and are glad of it, such a one says,
...
and the evidence of things not seen;`" such a one lives by faith,
